...
int TestSubMsg::read_from(BytesBuffer *buf) {
    return breeze::read_message_by_field(buf, [this](BytesBuffer *buf, int index) {
        switch (index) {
            case 1:
                return breeze::read_value(buf, this->myString, true, 0, "");
            case 2:
                return breeze::read_value(buf, this->myInt, true, 0, "");
            case 3:
                return breeze::read_value(buf, this->myInt64, true, 0, "");
            case 4:
                return breeze::read_value(buf, this->myFloat32, true, 0, "");
            case 5:
                return breeze::read_value(buf, this->myFloat64, true, 0, "");
            case 6:
                return breeze::read_value(buf, this->myByte, true, 0, "");
            case 7:
                return breeze::read_value(buf, this->myBytes, true, 0, "");
            case 8:
                return breeze::read_value(buf, this->myMap1, true, 0, "");
            case 9:
                return breeze::read_value(buf, this->myMap2, true, 0, "");
            case 10:
                return breeze::read_value(buf, this->myArray, true, 0, "");
            case 11:
                return breeze::read_value(buf, this->myBool, true, 0, "");
            default:
                return -1;
        }
    });
    ...
    return breeze::read_message_by_field(buf, [this](BytesBuffer *buf, int index) {
        switch (index) {
            ...
            case 2:
                return breeze::read_value(buf, this->myString, true, 0, "");
            case 3:
                return breeze::read_value(buf, this->myMap, true, 0, "");
            case 4:
                return breeze::read_value(buf, this->myArray, true, 0, "");
            case 5:
                return breeze::read_value(buf, this->subMsg, true, 0, "");
            case 6:
                return breeze::read_value(buf, this->myEnum, true, 0, "");
            case 7:
                return breeze::read_value(buf, this->enumArray, true, 0, "");
            default:
                return -1;
        }
    });
